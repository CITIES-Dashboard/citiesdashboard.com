...
const ValueRangeBox = ({ valueRange, filteredValueRange, colorAxis, isPortrait }) => {
    ...
    let { colors, isGradient, minValue, maxValue } = colorAxis;
    ...
    const minPositon = calculatePosition(filteredValueRange.min);
    const maxPosition = calculatePosition(filteredValueRange.max);
    ...
    return (
        <Box style={containerStyle}>
            <Box style={gradientStyle}>
                ...
                <span style={{ ...labelStyle, left: minPositon }}>min: {Math.round(filteredValueRange.min)}</span>
                <span style={{ ...labelStyle, left: maxPosition }}>max: {Math.round(filteredValueRange.max)}</span>
                <div style={{ ...triangleStyle, left: minPositon }}></div>
                <div style={{ ...triangleStyle, left: maxPosition }}></div>
            </Box>
        </Box>
    );
};
